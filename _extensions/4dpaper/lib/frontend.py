        ...
        if figures_dir:
            ...
            if frame_path.exists():
                frames_html_parts.append(
                    ...
                    f'      <iframe src="{fid}.html" id="{fid}" frameborder="0" class="frame-iframe"></iframe>'
